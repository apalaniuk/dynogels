...
const WriteItems = require('./batchWrite');
...
Table.prototype.writeItems = function () {
  const self = this;

  return new WriteItems(self, self.serializer);
};
...
Table.prototype.runBatchWriteItems = function (params, callback) {
  const self = this;
