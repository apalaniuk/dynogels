...
internals.compileModel = (name, schema, log) => {
  ...
  // transactions
  Model.transaction = {
    create: _.bind(table.transaction.create, table),
    modify: _.bind(table.transaction.modify, table),
    destroy: _.bind(table.transaction.destroy, table),
    put: _.bind(table.transaction.put, table),
    update: _.bind(table.transaction.update, table),
    delete: _.bind(table.transaction.delete, table),
    get: _.bind(table.transaction.get, table),
  };
...
dynogels.transaction = new Transaction(() => internals.loadDocClient(), () => dynogels.log);
