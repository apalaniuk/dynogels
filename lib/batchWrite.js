...
internals.initialBatchWriteItems = (items, table, serializer, options, callback) => {
  const serializedItems = items.map((i) => {
    ...
    req[i.type] = {
      Item: serializer.serializeItem(table.schema, i.item)
    };
...
module.exports = WriteItems = function(table, serializer) {
  this.table = table;
...
WriteItems.prototype.returnConsumedCapacity = function (value) {
